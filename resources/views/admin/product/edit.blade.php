                ...
                <div class="box-body row">
                    ...
                    <input type="hidden" name="item_id" value="{{ $product->item_id}}">
                        <div class="form-group">
                            ...
                            <input type="text" name="item_code" id="item_code"  placeholder="xxxxx" class="form-control"  value="{{ $product->item_code}}" > 
                        </div>
                        <div class="form-group">
                            <label for="name">Name <span class="text-danger">*</span></label>
                            <input type="text" name="item_name" id="item_name" placeholder="Name" class="form-control" required="" value="{{ $product->item_name}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="product_price" id="product_price" placeholder="Product Price" class="form-control" value="{{ $product->product_price }}" >
                            </div>
                        </div>
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"></span>
                                <input type="number" name="purchase_price" id="purchase_price" placeholder="Purchase Price" class="form-control" value="{{ $product->purchase_price }}" >
                            </div>
                        </div>
                         <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"></span>
                                                    <input type="number" required name="sales_price" id="sales_price" placeholder="Sale Price" class="form-control" value="{{ $product->sales_price }}" >
                                                </div>
                                            </div>
                                                ...
                                                <label for="categories">Category <span class="text-danger">*</span></label>
                                                    <select name="category_id" id="category_id" class="form-control select2"  required="">
                                                     @foreach($categories as $b)
                                                            ...
                                                            <option @if($product->category_id == $b->category_id) selected="selected" @endif value="{{$b->category_id}} ">{{$b->category_name}}</option>
                                                            @endforeach 
